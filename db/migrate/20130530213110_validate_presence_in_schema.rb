class ValidatePresenceInSchema < ActiveRecord::Migration
  def up
    change_column :projects, :name, :string, :null => false
    change_column :projects, :url, :string, :null => false
    change_column :projects, :code_base_url, :string, :null => false
  ...
  def down
    ...
    change_column :projects, :code_base_url, :string, :null => true
